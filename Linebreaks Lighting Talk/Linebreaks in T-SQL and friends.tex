...
\begin{columns}
    \column{.60\textwidth}
        \begin{itemize}
        \item There are three common encodings of line breaks in computers:
            \begin{itemize}
            \item character 13 followed by character 10 (Dos/Windows; \texttt{CR LF}; C-like: \texttt{\textbackslash{}r\textbackslash{}n}; PoSh: \texttt{\`{}r\`{}n})\\
            Modelled after how a type-writer behaves, when you switch to a new line
            \item character 10 (Unix/Linux; \texttt{LF}; C-like: \texttt{\textbackslash{}n}; PoSh: \texttt{\`{}n})\\
            Common with programmers/the web for brevity
            \item character 13 (Mac; \texttt{CR}; C-like: \texttt{\textbackslash{}r}; PoSh: \texttt{\`{}r})\\
            After Mac OS X adopted the Unix standard of \texttt{LF}, this is mostly extinct
            \end{itemize}
        \end{itemize}
    \column{.40\textwidth}
        \begin{center}
            \todo{Image of a typewriter or similar}
